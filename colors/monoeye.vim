  ...
  let s:shade6 = "#bab5bb"
  let s:shade7 = "#d2ccd2"
  let s:accent0 = "#81a2be"
  let s:accent1 = "#5f819d"
  let s:accent2 = "#db5f5a"
  let s:accent3 = "#93a87a"
  let s:accent4 = "#fb8f8e"
  let s:accent5 = "#826082"
  let s:accent6 = "#e7c355"
  let s:accent7 = "#81a2be"
